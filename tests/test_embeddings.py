...
class TestEmbeddingFactory:
    ...
    def test_create_ollama_provider(self):
        ...
        provider = create_embedding_provider(provider_type="ollama", model="nomic-embed-text")
    ...
    def test_create_ollama_with_custom_host(self):
        ...
        provider = create_embedding_provider(
            provider_type="ollama", model="nomic-embed-text", host="http://custom-host:11434"
        )
    ...
    def test_sentence_transformers_not_implemented(self):
        ...
        with pytest.raises(
            NotImplementedError, match="SentenceTransformers provider not yet implemented"
        ):
